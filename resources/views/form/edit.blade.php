                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="nama_kelurahan" name="nama_kelurahan" class="form-control"
                                    id="nama_kelurahan" value="{{$data->nama_kelurahan}}"
                                    aria-describedby="nama_kelurahan" placeholder="masukkan nama keluharan" required>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="nama_survei" name="nama_survei" class="form-control" id="nama_survei"
                                    value="{{$data->nama_survei}}" aria-describedby="nama_survei"
                                    placeholder="masukkan nama survei" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="total_target" name="total_target" class="form-control" id="total_target"
                                    value="{{$data->total_target}}" aria-describedby="total_target"
                                    placeholder="masukkan total target" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="total_petugas" name="total_petugas" class="form-control" id="total_petugas"
                                    value="{{$data->total_petugas}}" aria-describedby="total_petugas"
                                    placeholder="masukkan total petugas" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="total_pengawas" name="total_pengawas" class="form-control"
                                    id="total_pengawas" value="{{$data->total_pengawas}}"
                                    aria-describedby="total_pengawas" placeholder="masukkan total pengawas" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="jh_penyelesaian" name="jh_penyelesaian" class="form-control"
                                    id="jh_penyelesaian" value="{{$data->jh_penyelesaian}}"
                                    aria-describedby="jh_penyelesaian" placeholder="masukkan jangka hari selesai"
                                    required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="target_petugas" name="target_petugas" class="form-control"
                                    id="target_petugas" value="{{$data->target_petugas}}"
                                    aria-describedby="target_petugas" placeholder="masukkan target petugas" required>
                            </div>
                        </div>
                    </div>
