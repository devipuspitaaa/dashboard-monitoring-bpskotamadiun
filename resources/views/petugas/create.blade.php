            ...
            <form method="post" action="{{ route('petugas.store') }}" class="form-horizontal">
                ...
                <div class="featured__controls">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="nama_lengkap" name="nama_lengkap" class="form-control" id="nama_lengkap"
                                    aria-describedby="nama_lengkap" placeholder="masukkan nama lengkap" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="no_ktp" name="no_ktp" class="form-control" id="no_ktp"
                                    aria-describedby="no_ktp" placeholder="masukkan no. ktp" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="tempat_tanggal_lahir" name="tempat_tanggal_lahir" class="form-control datepicker"
                                    id="tanggal" aria-describedby="tempat_tanggal_lahir"
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="no_tlp" name="no_tlp" class="form-control" id="no_tlp"
                                    aria-describedby="no_tlp" placeholder="masukkan no. telepon" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
